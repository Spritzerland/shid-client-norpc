...
public class RenderManager {
	...
	public static float field_1225_i;
	public static float field_1224_j;
	public static GameSettings options;
	public static double field_1222_l;
	public static double field_1221_m;
	public static double field_1220_n;
