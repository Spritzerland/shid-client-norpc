...
public class Client {
        ...
        Thread thread = new Thread() {
            public void run() {
                try{
                    ...
                    if(needsUpdate) {
                        Desktop.getDesktop().browse(URI.create("https://github.com/stever9487/shid-client/releases"));
                    }
                }catch(Exception ex) {
                    ex.printStackTrace();
                }
    ...
    public static void hacksLoad() throws IOException {
        ...
        if(!file.exists()) {
            ...
            hacks[21].setToggle(true);
            hacks[22].setToggle(true);
            hacks[23].setToggle(true);
            hacks[24].setToggle(true);
        }
    ...
    private void register(){
        ...
        addHack(21, new Nametags());
        addHack(22, new DiscordRPC());
        addHack(23, new Tracers());
        addHack(24, new ESP());
