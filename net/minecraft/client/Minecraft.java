...
public abstract class Minecraft implements Runnable {
	...
	public void startGame() throws LWJGLException {
		...
		if(Client.hacks[22].isToggled()) Discord.startRPC();
	...
	private void clickMouse(int var1) {
		if(Client.hacks[11].isToggled()) {
			this.field_6282_S = 0; // leftClickCounter
		}
										...
										do {
											if(!Keyboard.next()) {
												if(this.currentScreen == null) {
													...
													if(Mouse.isButtonDown(1) && (float)(this.ticksRan - this.field_6302_aa) >= this.timer.ticksPerSecond / 4.0F && this.field_6289_L || Mouse.isButtonDown(1) && Client.hacks[11].isToggled() && this.field_6289_L) {
														this.clickMouse(1);
														this.field_6302_aa = this.ticksRan;
													}
												}
